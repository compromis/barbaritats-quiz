  ...
  <div class="results-wrapper">
    <div class="results" id="results">
      ...
      <p class="social-plugins">
        <iframe src="https://www.facebook.com/plugins/like.php?href=https://compromis.net/quiz/barbaritats/&width=198&layout=button_count&action=like&size=large&show_faces=false&share=true&height=37&appId=252515324782640&locale=ca_ES" width="213" allowtransparency="true" scrolling="no" class="social-plugins-facebook" frameborder="0" height="30"></iframe>
        <iframe :src="'https://platform.twitter.com/widgets/tweet_button.html?size=l&url=https://compromis.net/quiz/barbaritats/&via=compromis&related=compromis&text=' + encodeURIComponent(tweet) + '&lang=es'" class="social-plugins-twitter" width="100" height="30" allowtransparency="true" scrolling="no" frameborder="0"></iframe>
      </p>
      <hr />
...
export default {
  ...
  computed: {
    ...
    tweet: function () {
      return 'He tret un ' + this.correctAnswers + ' de ' + this.totalQuestions + ' en el quiz les barbaritats en campanya de @compromis. Pots superar-me?'
    }
  },
